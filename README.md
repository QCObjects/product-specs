...
**Published docs:** local preview via `mkdocs serve` · GitHub Pages (live after
first `main` deploy) · Read the Docs (live after importing `qcobjects-product-specs`
at readthedocs.org with `.readthedocs.yaml`).
